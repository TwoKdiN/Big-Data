...
W.addLink('Street1', 'LStreet1','RStreet1', length=1000, free_flow_speed=20, number_of_lanes = 1, jam_density=0.2, merge_priority=0.5)
W.addLink('Street2', 'LStreet2','RStreet2', length=1000, free_flow_speed=20, number_of_lanes = 1, jam_density=0.2, merge_priority=0.5)
