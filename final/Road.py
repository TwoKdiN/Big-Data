...
#Demands
# 9:00 - 8:59 (NEXT DAY)
W.adddemand('Start01', 'Dest0', 0, 3600, 0.1)
W.adddemand('Start01', 'Dest0', 0, 3600, 0.1)
W.adddemand('Start02', 'Dest0', 0, 3600, 0.1)
W.adddemand('Start02', 'Dest0', 0, 3600, 0.1)
W.adddemand('Start03', 'Dest0', 0, 3600, 0.1)
W.adddemand('Start03', 'Dest0', 0, 3600, 0.1)

# # 9:00 - 11:00
# W.adddemand('Start01', 'Dest0', 0, 3600, 0.4)
# W.adddemand('Start01', 'Dest0', 0, 600, 0.8)
# W.adddemand('Start02', 'Dest0', 0, 3000, 0.4)
# W.adddemand('Start02', 'Dest0', 0, 1000, 0.8)
# W.adddemand('Start03', 'Dest0', 0, 2000, 0.4)
# W.adddemand('Start03', 'Dest0', 0, 3000, 0.8)
